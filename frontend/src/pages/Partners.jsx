          ...
          <div className="row">
            <div className="col-sm">
              <div className="row minh-50">
                <img src={partnerEu} style={{maxWidth: '340px', margin: '20px auto'}} className='mb-3' alt=""/>
                <h2>Europs sajungos fondas</h2>
                <p>
              ...
              <div className="row">
                <img src={partnerVersliLt} style={{maxWidth: '340px', margin: '20px auto'}} className='img-fluid mb-3' alt=""/>
            ...
            <div className="col-sm">
            <div className="row">
                <img src={partnerInvega} style={{maxWidth: '340px', margin: '20px auto'}} className='img-fluid mb-3' alt=""/>
              ...
              <div className="row">
                <img src={partnerLtBank} style={{maxWidth: '340px', margin: '20px auto'}} className='img-fluid mb-3' alt=""/>
